  ...
  <style>
    ...
    <div class="container">
        ...
        <div class="col-md-3 hidden-xs ">
          ...
          <h5 class="judul-sub-pro">  <a href="{{url('brand/'.$brandname->brand_url.'/'.$categ->kateg_url)}}" style="color:#000;">VIEW ALL {{$categ->kateg_name}}</a></h5>
          <ul class="topnav">
            <?php $i = 1; ?>
              ...
              @foreach($categparent as $parent)
                @foreach($prod as $productparent)
                  @if($categ->kateg_id==$parent->kateg_parent)
                      ...
                      <li id="{{$i}}">
                        <a href="{{url('brand/'.$brandname->brand_url.'/'.$parent->kateg_url)}}" style="">{{$parent->kateg_name}}</a>
                                    ...
                                    @foreach($prod as $productparent2)
                                        @if($parent->kateg_id==$parent2->kateg_parent )
                                          <?php if(in_array($parent2->kateg_id,explode(',',$productparent2->prod_category))){?>
                                              <li><a href="{{url('brand/'.$brandname->brand_url.'/'.$brandname->brand_url.'/'.$parent2->kateg_url)}}">{{$parent2->kateg_name}}</a></li>
                                          <?php break; } ?>
                                        @endif
                                    @endforeach
                                  @endforeach
            ...
            <h5 class="judul-kat-pro">BRAND <span style="float: right;">
              <a href="{{url('product/'.$categurl)}}" type="button"  class="close" aria-label="Close">{{$brandname->brand_name}}
                            ...
                            @if($categ->kateg_id==$parent->kateg_parent)
                              <?php if(in_array($parent->kateg_id,explode(',',$productparent->prod_category))){?>
                                  <li> <a href="#"  class="plus" style="position:absolute;right:15px;"></a>
                                      <a href="{{url('brand/'.$brandname->brand_url.'/'.$parent->kateg_url)}}" id="parenturl{{$par}}" style="margin-right:20px;">{{$parent->kateg_name}}</a>
                                      @foreach($categparent2 as $parent2)
                                        @foreach($prod as $productparents2)
                                          @if($parent->kateg_id==$parent2->kateg_parent )
                                              <?php if(in_array($parent2->kateg_id,explode(',',$productparents2->prod_category))){?>
                                                    <ul>
                                                      ...
                                                      @foreach($categparent2 as $parent2)
                                                        @foreach($prod as $productparent2)
                                                            @if($parent->kateg_id==$parent2->kateg_parent )
                                                            <?php if(in_array($parent2->kateg_id,explode(',',$productparent2->prod_category))){?>
                                                                <li><a href="{{url('brand/'.$brandname->brand_url.'/'.$parent2->kateg_url)}}">{{$parent2->kateg_name}}</a></li>
                                                           <?php break; } ?>
                                                            @endif
                                                        @endforeach
                                                      @endforeach
