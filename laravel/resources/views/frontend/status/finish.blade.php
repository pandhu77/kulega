  ...
  <div class="container">
      <div class="col-sm-12 list-outer-title text-center">
        <label class="page-title">Thank You, {{ $row->member_fullname}}</label>
          Transaction Invoice No: {{$row->order_id}} successfully. The Order will be processed. You will receive further notification.
      </div>
      <span class="sep"></span>
      ...
      <!-- <div class="table-responsive"> -->
        <table class="table"style="width: 100%;max-width: 100%;">
          <tbody>
            ...
            <!-- <tr>
              <th>Unique Code (+)</th>
              <td style="text-align:right;"><span class="price_format">{{$row->order_generate}}</span></td>
            </tr> -->
    ...
    <!-- <div class="col-sm-12">
      <a href="{{ url('user/order/detail/'.$row->order_id)}}" class="btn btn-primary btn-xs pull-right back">Detail Order</a>
    </div> -->
