...
<title>{{web_name()}} | Error Payment</title>
  <div class="container">
      <div class="col-sm-12 list-outer-title text-center">
        <label class="page-title">Sorry, {{ $row->member_fullname}}</label>
          Transaction Invoice No: {{$row->order_id}} Error. Please make payment until finish. <a href="{{url('payment/make-payment/'.$row->order_id)}}" style="color:#b2203d !important;">Make Payment</a>
      </div>
      <span class="sep"></span>
