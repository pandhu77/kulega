...
<title>E-Commerce Djaring.id | Reset Password</title>
<div class="container">
	...
	<div class="form">
      <div class="tab-content">
          ...
          <form action="{{url('vendor/new-password/'.$token)}}" method="post">
            ...
            <div class="field-wrap">
              ...
              <input type="password" required autocomplete="off" name="vendor_password" value=""/>
            </div>
            <div class="field-wrap">
              <label>
