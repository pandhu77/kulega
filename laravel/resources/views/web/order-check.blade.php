        ...
        <div class="container clearfix">
            ...
            <div class="col-sm-offset-4 col-sm-4">
                <div class="input-group">
                    <input type="text" class="form-control" name="orderid" placeholder="Order ID / Email" style="border-radius:0px;">
                    <span class="input-group-btn">
                        <a href="javascript:void(0)" class="btn btn-default" onclick="getorderinfo()" style="border-radius:0px;">Search !</a>
                    </span>
                </div><!-- /input-group -->
            </div>
