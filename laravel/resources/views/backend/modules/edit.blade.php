...
<div class="row">
    <form class="form-horizontal" action="{{ url('backend/themes-module/'.$module->id) }}/edit" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mail_heading row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10" style="padding-left:0px;padding-right:0px;">
                                                <textarea name="m_function" class="form-control" rows="10" required>{{ $module->m_function }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10" style="padding-left:0px;padding-right:0px;">
                                                <input type="text" name="m_return" class="form-control" value="{{ $module->m_return }}" required>
                                            </div>
                                        </div>
                                        ...
                                        @foreach($submodule as $sub)
                                            <div class="submod-row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10" style="padding-left:0px;padding-right:0px;">
                                                        <textarea name="det_html[]" class="form-control" rows="10" required>{{ $sub->det_html }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php $i++; ?>
...
<script type="text/javascript">
    ...
    function addsubmod(){
        $('#content-submod').append('   <div class="submod-row'+i+'">'+
                                    ...
                                    '               <input type="text" class="form-control" name="sub_name[]" value="{{ old("name") }}" required>'+
                                    '           </div>'+
                                    ...
                                    '           <label class="col-sm-2 control-label" style="padding-left:0px;padding-right:0px;">HTML</label>'+
                                    '           <div class="col-sm-10" style="padding-left:0px;padding-right:0px;">'+
                                    '               <textarea name="det_html[]" class="form-control" rows="10" required></textarea>'+
                                    '           </div>'+
                                    '       </div>'+
                                    '   </div>');
