            ...
            <div class="inbox-body">
              <div class="mail_heading row">
                ...
                <div class="col-md-12">
                  ...
                  <form class="form-horizontal" action="{{action('Backend\UserAccessController@store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9"style="text-align:left;padding-left:0px;padding-right:0px;">
                            <input type="checkbox" name="type"> Super Access(access to delete data)
                      </div>
                    </div>
