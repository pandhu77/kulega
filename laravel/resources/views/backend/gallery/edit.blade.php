...
<div class="row">
  <div class="col-md-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Gallery<small>management</small></h2>
        <div class="clearfix"></div>
      </div>
      <div class="x_content">
        <div class="row">
              ...
              <div class="mail_heading row">
                ...
                <div class="col-md-12">
                  @if(Session::has('success'))
                    ...
                    @if(Session::has('errors-data'))
                      ...
                      @endif
                  <form class="form-horizontal" action="{{url('backend/gallery/'.$row->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10" style="padding-left:0px;padding-right:0px;">
                        <input type="text" class="form-control" name="title"placeholder="Title"  style=""value="{{$row->title}}">
                      </div>
                    </div>
                ...
                <div class="col-md-12" style="text-align:right;">
                  <div class="btn-group">
                    ...
                    <a href="{{url('backend/gallery')}}" class="btn btn-sm btn-default" type="button"  data-placement="top" data-toggle="tooltip" data-original-title="Back"><i class="fa fa-share"></i> Back</a>
                  </div>
                </form>
                </div>
              </div>
