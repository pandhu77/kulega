            ...
            <div class="inbox-body">
              <div class="mail_heading row">
                ...
                <div class="col-md-12">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{action('Backend\BankController@store')}}" method="post" enctype="multipart/form-data">
