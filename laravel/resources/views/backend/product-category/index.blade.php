...
<div class="page-title">
  <div class="title_left">
    <h3>Product Category <small>show all product category</small></h3>
  </div>
...
<div class="clearfix"></div>
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
      <div class="x_title">
        <h2>Master Data <small>Product Category</small></h2>
        <div class="text-right" style="margin-bottom:20px;">
                    <a href="{{ url('backend/product-category/create') }}" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> Add New</a>
                </div>
        <div class="clearfix"></div>
            ...
            @foreach($kateg as $data)
              <tr>
                ...
                <td data-label="Action">
                  <div  class="btn-group">
                    <form id="{{ $data->kateg_id }}" action="{{ url('backend/product-category/'.$data->kateg_id)}}" method="post">
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <input type="hidden" name="_method" value="DELETE">
                      <a href="{{ url('backend/product-category/'.$data->kateg_id.'/edit')}}" title="View This Category" data-toggle="tooltip" class="btn btn-sm btn-primary" data-toggle="tooltip"><span class="fa fa-edit" aria-hidden="true"></span></a>
