              ...
              <div class="mail_heading row">
                ...
                <div class="col-md-12">
                  @if(Session::has('success'))
                    ...
                    @endif
                  <form class="form-horizontal" action="{{action('Backend\BonusController@store')}}" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                      <div class="form-group">
                        <label class="col-sm-3 control-label" style="padding-left:0px;padding-right:0px;">Name</label>
                        <div class="col-sm-9" style="padding-left:0px;padding-right:0px;">
                          <input type="text"  class="form-control" name="bonus_name"placeholder="" style=""value="" required>
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-9" style="padding-left:0px;padding-right:0px;">
                               <input id="bonusvalue" type="text" class="form-control" placeholder="" name="bonus_value" required>
                           </div>
                       </div>
                       ...
                       <div class="form-group">
                         ...
                         <div class="col-sm-9" style="padding-left:0px;padding-right:0px;">
                           <input type="number"  class="form-control" name="bonus_poin"placeholder="" style=""value="" required>
                         </div>
                       </div>
