                        ...
                        <div class="inbox-body">
                            <div class="mail_heading row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @endif
                                    <form class="form-horizontal" action="{{action('Backend\CmsPageController@store')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10" style="padding-left:0px;padding-right:0px;">
                                                <input type="checkbox" name="enable"> Publish
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10" style="padding-left:0px;padding-right:0px;">
                                                <input type="text" class="form-control" name="url"placeholder="Url" id="url"  style=""value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <b>Full URL : </b><span id="full-url">{{ url('page/') }}</span>
                                            </div>
                                        </div>
