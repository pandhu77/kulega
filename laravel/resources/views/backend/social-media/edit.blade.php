                ...
                <div class="col-md-12">
                  @if(Session::has('success'))
                    ...
                    @if(Session::has('errors-data'))
                      ...
                      @endif
                  <form class="form-horizontal" action="{{url('backend/social-media/'.$row->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9"style="text-align:left;padding-left:0px;padding-right:0px;" >
                          ...
                          <img src="{{asset($row->icon)}}" id="viewimg" class="img-responsive" style="max-width:1000px;max-height:300px;"/><br/> -->
                          <input type="text" value="{{asset($row->icon)}}" name="image" class="form-control" id="img">
                      </div>
                    </div>
