                ...
                <div class="col-md-12">
                  @if(Session::has('success'))
                    ...
                    @if(Session::has('errors-data'))
                      ...
                      @endif
                  <form class="form-horizontal" action="{{action('Backend\DiscountLevelController@store')}}" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-4" style="padding-left:0px;padding-right:0px;">
                              <input   type="number" class="form-control" placeholder="Min" name="min_value" id="rf" required>
                          </div>
                          ...
                          <div class="col-sm-4"style="padding-left:0px;padding-right:0px;">
                              <input  type="number" class="form-control" placeholder="Max" name="max_value" id="ru" required>
                          </div>
                      </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-9" style="padding-left:0px;padding-right:0px;">
                               <input  type="number" class="form-control" placeholder="" name="disc_value" required>
                           </div>
                       </div>
                       ...
                       <div class="form-group">
                         ...
                         <div class="col-sm-9" style="padding-left:0px;padding-right:0px;">
                           <input type="number"  class="form-control" name="disc_value_uth"placeholder="" style=""value="" required>
                         </div>
                       </div>
                       <div class="form-group">
                         <label class="col-sm-3 control-label" style="padding-left:0px;padding-right:0px;">Birth Day Limit( day H + )</label>
                         <div class="col-sm-9" style="padding-left:0px;padding-right:0px;">
                           <input type="number"  class="form-control" name="disc_limit_uth"placeholder="" style=""value="" required>
                         </div>
                       </div>
