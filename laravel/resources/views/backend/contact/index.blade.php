@extends('backend/app')
@section('content')
<title>System | Contact </title>
<div class="page-title">
   <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="title_left">
      <h3>Contact Management <small>show all slider</small></h3>
    </div>
  </div>
...
<div class="clearfix"></div>
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Master Data <small>Contact</small></h2>
          ...
          <tbody>
            ...
            @foreach($data as $key => $dat)
              <tr>
                ...
                <td data-label="Subject">{{ $dat->subject }}</td>
