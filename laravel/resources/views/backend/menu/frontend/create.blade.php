                ...
                <div class="col-md-12">
                  @if(Session::has('success'))
                    ...
                    @if(Session::has('errors-data'))
                      ...
                      @endif
                  <form class="form-horizontal" action="{{action('Backend\MenuFrontendController@store')}}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group hidden">
                          ...
                          <div class="col-sm-9" style="padding-left:0px;padding-right:0px;">
                              <select name="type" class="form-control" required>
                                ...
                                <option value="Footer" selected>Footer Menu</option>
                              </select>
                          </div>
                      </div>
                      ...
                      <div class="form-group hidden">
                          ...
                          <div class="col-sm-9" style="padding-left:0px;padding-right:0px;">
                              <select name="parent" class="form-control select2" required>
                                ...
                                @foreach($menu as $men)
                                    <option value="{{ $men->menu_id }}">{{ $men->menu }}</option>
                                @endforeach
                              </select>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9"style="padding-left:0px;padding-right:0px;">
                          ...
                          <div style="margin-top:10px;">
                              <select class="form-control hidden" name="url" id="selectpages">
                                  <option disabled selected>Select One</option>
                                  @foreach($pages as $pag)
                                    <option value="page/{{ $pag->url }}">{{ $pag->title }}</option>
                                  @endforeach
                              </select>
                              <input type="text" class="form-control hidden" name="url" value="http://" id="costumurl">
                          </div>
                        </div>
                      </div>
