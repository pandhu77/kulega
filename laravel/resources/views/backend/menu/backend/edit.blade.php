                ...
                <div class="col-md-12">
                  @if(Session::has('success'))
                    ...
                    @if(Session::has('errors-data'))
                      ...
                      @endif
                  <form class="form-horizontal"  action="{{url('backend/backend-menu/'.$row->menu_id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="_method" value="PUT">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9"style="padding-left:0px;padding-right:0px;" class="col-sm-3 text-left">
                            <input type="checkbox" name="status_menu" <?php if($row->status_menu==1){ echo 'checked'; }?>> Enable
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-9"style="padding-left:0px;padding-right:0px;" class="col-sm-3 text-left">
                          <select name="group" required class="form-control">
                                  ...
                                  <option value="0" <?php if($row->group==0){echo 'selected="selected"';}?> >Main Menu</option>
                                  @foreach($menu as $parent)
                                    <option value="{{$parent->menu_id}}" <?php if($row->group==$parent->menu_id){echo 'selected="selected"';}?>>{{$parent->menu}}</option>
                                  @endforeach
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9"style="padding-left:0px;padding-right:0px;">
                          <input type="text"  class="form-control" name="name" value="{{$row->menu}}">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-3 text-left"style="padding-left:0px;padding-right:0px;">Url</label>
                        <div class="col-sm-9"style="padding-left:0px;padding-right:0px;">
                          <input type="text" name="url" class="form-control" id="url"value="<?php  echo substr($row->url,8)?>" >
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                         ...
                         <div class="col-sm-9"style="padding-left:0px;padding-right:0px;" class="col-sm-3 text-left">
                             <input type="checkbox" name="status_parent" <?php if($row->parent==1){ echo 'checked' ;}?>> Yes
                         </div>
                       </div>
