...
<div class="page-title">
  <div class="title_left">
    <h3>Category Donate <small>show all category donate</small></h3>
  </div>
...
<div class="clearfix"></div>
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
      <div class="x_title">
        <h2>Master Data <small>Category Donate</small></h2>
        <div class="text-right" style="margin-bottom:20px;">
            <a href="{{ url('backend/donatecate/create/') }}" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> Add New</a>
        </div>
        <div class="clearfix"></div>
      </div>
      <div class="x_content">
              ...
              <tr>
                ...
                <td data-label="Action">
                  <div  class="btn-group" data-id="{{ $data->id }}">
                      <a href="{{ url('backend/donatecate/edit/'.$data->id)}}" title="Update This Category" data-toggle="tooltip" class="btn btn-sm btn-primary" data-toggle="tooltip"><span class="fa fa-edit" aria-hidden="true"></span></a>
...
$(document).ready(function(){
    $('.btnDelete').click(function(e){
        ...
        swal({
          ...
          {
            $.ajax({
                url : "{{ url('/backend/donatecate/delete/') }}",
                method : "POST",
                data : { id : _id,_token : "{{ csrf_token() }}" }
            }).success(function(response){
                if("OK" === response.Result)
                {
                    location.href = "{{ url('/backend/donatecate/show/') }}";
                }
                else
                {
