...
<div class="page-title">
  <div class="title_left">
    <h3>Low Stock <small>show all product</small>
    </h3>
  </div>
    ...
    <div class="x_panel">
      <div class="x_title">
        ...
        <div class="text-right" style="margin-bottom:20px;">
            <form class="" action="{{ url('backend/product-low-stock') }}" method="get">
                <div class="input-form">
                    <label for="">Stock Remaining : </label>
                    <input type="text" name="remaining" placeholder="Number" value="<?php echo $_GET['remaining'] ?>" style="height: 34px;border-radius: 5px;">
