                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('user_fullname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="user_fullname" value="{{ old('user_fullname') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('user_phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control" name="user_phone" value="{{ old('user_phone') }}" required autofocus>
